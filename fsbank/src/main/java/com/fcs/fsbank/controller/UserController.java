...
import com.fcs.fsbank.constants.ApplicationConstants;
import com.fcs.fsbank.model.Customer;
import com.fcs.fsbank.model.LoginRequestDTO;
import com.fcs.fsbank.model.LoginResponseDTO;
    ...
    public ResponseEntity<LoginResponseDTO> apiLogin (@RequestBody LoginRequestDTO loginRequest) {
        ...
        if(Objects.nonNull(authenticationResponse) && authenticationResponse.isAuthenticated()) {
            if (Objects.nonNull(env)) {
                ...
                jwt = Jwts.builder().issuer("FS Bank").subject("JWT Token")
